  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        workingTreeChanges: "تغييرات مساحة العمل",
        changedFile: "ملف {{count}}",
        changedFiles: "ملفات {{count}}",
        fileActions: "إجراءات الملف",
        stageFile: "إضافة إلى التغييرات المرحلية",
        unstageFile: "إرجاع إلى مساحة العمل",
        failedStageFile: "فشل تجهيز الملف.",
        failedUnstageFile: "فشل إلغاء تجهيز الملف.",
      },
      openInEditor: {
        open: "يفتح",
  ...
  settings: {
    ...
    general: {
      ...
      cloudSync: {
        ...
        rowTitle: "مزامنة حالة الواجهة المشفرة",
        rowHint:
          "تتم مزامنة المضيفين وتبويبات مساحة العمل والتخطيط والإعدادات ومسودات النصوص. لا تتم مزامنة بيانات المرفقات.",
        endpoint: {
          label: "نقطة نهاية المزامنة",
          hint: "مثال: https://sync.example.com",
        ...
        signedInDetails: "{{username}} · المراجعة {{revision}} · {{lastSync}}",
        signedOutHint: "سجل أو ادخل باستخدام كلمة المرور الرئيسية نفسها المستخدمة للتشفير.",
        actions: {
          push: "رفع",
          pull: "سحب",
        ...
        errorTitle: "فشلت المزامنة السحابية",
        errors: {
          signInRequired: "سجل الدخول قبل المزامنة.",
          endpointRequired: "نقطة نهاية المزامنة مطلوبة.",
          usernameRequired: "اسم المستخدم مطلوب.",
          passwordRequired: "كلمة المرور مطلوبة.",
          webCryptoRequired: "تتطلب المزامنة السحابية دعم Web Crypto في بيئة التشغيل هذه.",
          unsupportedSnapshot: "لقطة المزامنة المشفرة غير مدعومة.",
          invalidSnapshot: "لقطة المزامنة السحابية غير صالحة.",
          revisionConflict: "يوجد تعارض في المراجعة. اسحب أحدث حالة ثم حاول مرة أخرى.",
          missingBearerToken: "رمز Bearer مفقود.",
          invalidBearerToken: "الجلسة غير صالحة أو انتهت صلاحيتها. سجل الدخول مرة أخرى.",
          userNotFound: "لم يتم العثور على المستخدم.",
          invalidJsonBody: "نص طلب المزامنة غير صالح.",
          ...
          invalidBaseRevision: "المراجعة الأساسية غير صالحة.",
          notFound: "لم يتم العثور على نقطة نهاية المزامنة.",
          internalServerError: "خطأ في خادم المزامنة.",
          requestFailed: "فشل طلب المزامنة ({{status}}).",
        },
      },
    },
    diagnostics: {
