export const en = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        stageFile: "Add to staged changes",
        unstageFile: "Restore to working tree",
        failedStageFile: "Failed to stage file.",
        failedUnstageFile: "Failed to unstage file.",
        commits: {
          title: "Commits",
  ...
  settings: {
    ...
    general: {
      ...
      cloudSync: {
        title: "Cloud sync",
        rowTitle: "Encrypted UI state sync",
        rowHint:
          "Syncs hosts, workspace tabs, layout, settings, and text drafts. Attachment bytes are not synced.",
        endpoint: {
          label: "Sync endpoint",
          hint: "Example: https://sync.example.com",
        ...
        signedInDetails: "{{username}} · revision {{revision}} · {{lastSync}}",
        signedOutHint: "Register or sign in with the same master password used for encryption.",
        actions: {
          push: "Push",
          pull: "Pull",
          signOut: "Sign out",
        ...
        errorTitle: "Cloud sync failed",
        errors: {
          signInRequired: "Sign in before syncing.",
          endpointRequired: "Sync endpoint is required.",
          usernameRequired: "Username is required.",
          passwordRequired: "Password is required.",
          webCryptoRequired: "Cloud sync requires Web Crypto support in this runtime.",
          unsupportedSnapshot: "Unsupported encrypted sync snapshot.",
          invalidSnapshot: "Invalid cloud sync snapshot.",
          revisionConflict: "Revision conflict. Pull latest state, then try again.",
          missingBearerToken: "Missing bearer token.",
          invalidBearerToken: "Invalid or expired session. Sign in again.",
          userNotFound: "User not found.",
          invalidJsonBody: "Invalid sync request body.",
          invalidUsername: "Invalid username.",
          userAlreadyExists: "User already exists.",
          invalidCredentials: "Invalid username or password.",
          invalidBaseRevision: "Invalid base revision.",
          notFound: "Sync endpoint not found.",
          internalServerError: "Sync server error.",
          requestFailed: "Sync request failed ({{status}}).",
        },
      },
    },
    diagnostics: {
