  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        stagedChanges: "Cambios en staging",
        workingTreeChanges: "Cambios del árbol de trabajo",
        changedFile: "{{count}} archivo",
        changedFiles: "{{count}} archivos",
        fileActions: "Acciones de archivo",
        stageFile: "Añadir a cambios en staging",
        unstageFile: "Restaurar al árbol de trabajo",
        failedStageFile: "No se pudo añadir el archivo al staging.",
        failedUnstageFile: "No se pudo quitar el archivo del staging.",
      },
      openInEditor: {
        open: "Abierto",
