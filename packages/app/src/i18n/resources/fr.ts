  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        workingTreeChanges: "Modifications du répertoire de travail",
        changedFile: "{{count}} fichier",
        changedFiles: "{{count}} fichiers",
        fileActions: "Actions sur le fichier",
        stageFile: "Ajouter aux modifications indexées",
        unstageFile: "Restaurer dans le répertoire de travail",
        failedStageFile: "Échec de l'indexation du fichier.",
        failedUnstageFile: "Échec du retrait de l'index.",
      },
      openInEditor: {
        open: "Ouvrir",
  ...
  settings: {
    ...
    general: {
      ...
      cloudSync: {
        ...
        rowTitle: "Synchronisation chiffrée de l'état de l'interface",
        rowHint:
          "Synchronise les hôtes, les onglets d'espace de travail, la disposition, les paramètres et les brouillons texte. Les octets des pièces jointes ne sont pas synchronisés.",
        endpoint: {
          label: "Point de terminaison de synchronisation",
          hint: "Exemple : https://sync.example.com",
        ...
        signedInDetails: "{{username}} · révision {{revision}} · {{lastSync}}",
        signedOutHint:
          "Inscrivez-vous ou connectez-vous avec le même mot de passe principal utilisé pour le chiffrement.",
        actions: {
          push: "Envoyer",
          pull: "Récupérer",
        ...
        errorTitle: "Échec de la synchronisation cloud",
        errors: {
          signInRequired: "Connectez-vous avant de synchroniser.",
          endpointRequired: "Le point de terminaison de synchronisation est requis.",
          usernameRequired: "Le nom d'utilisateur est requis.",
          passwordRequired: "Le mot de passe est requis.",
          webCryptoRequired:
            "La synchronisation cloud nécessite la prise en charge de Web Crypto dans cet environnement.",
          unsupportedSnapshot: "L'instantané de synchronisation chiffré n'est pas pris en charge.",
          invalidSnapshot: "L'instantané de synchronisation cloud n'est pas valide.",
          revisionConflict: "Conflit de révision. Récupérez le dernier état, puis réessayez.",
          missingBearerToken: "Jeton bearer manquant.",
          invalidBearerToken: "Session invalide ou expirée. Connectez-vous à nouveau.",
          userNotFound: "Utilisateur introuvable.",
          invalidJsonBody: "Corps de requête de synchronisation invalide.",
          invalidUsername: "Nom d'utilisateur invalide.",
          userAlreadyExists: "L'utilisateur existe déjà.",
          invalidCredentials: "Nom d'utilisateur ou mot de passe invalide.",
          invalidBaseRevision: "Révision de base invalide.",
          notFound: "Point de terminaison de synchronisation introuvable.",
          internalServerError: "Erreur du serveur de synchronisation.",
          requestFailed: "La requête de synchronisation a échoué ({{status}}).",
        },
      },
    },
    diagnostics: {
