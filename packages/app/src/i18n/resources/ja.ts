...
export const ja: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        changedFile: "{{count}}件のファイル",
        changedFiles: "{{count}}件のファイル",
        fileActions: "ファイル操作",
        stageFile: "ステージ済みに追加",
        unstageFile: "作業ツリーに戻す",
        failedStageFile: "ファイルのステージに失敗しました。",
        failedUnstageFile: "ファイルのステージ解除に失敗しました。",
        commits: {
          title: "コミット",
  ...
  settings: {
    ...
    general: {
      ...
      cloudSync: {
        title: "クラウド同期",
        rowTitle: "暗号化されたUI状態の同期",
        rowHint:
          "ホスト、ワークスペースのタブ、レイアウト、設定、テキスト下書きを同期します。添付ファイルのバイトデータは同期されません。",
        endpoint: {
          label: "同期エンドポイント",
          hint: "例: https://sync.example.com",
        ...
        lastSyncNever: "まだ同期されていません",
        signedInDetails: "{{username}} · リビジョン {{revision}} · {{lastSync}}",
        signedOutHint: "暗号化に使う同じマスターパスワードで登録またはサインインしてください。",
        actions: {
          push: "プッシュ",
          pull: "プル",
          signOut: "サインアウト",
        ...
        errorTitle: "クラウド同期に失敗しました",
        errors: {
          signInRequired: "同期する前にサインインしてください。",
          endpointRequired: "同期エンドポイントが必要です。",
          usernameRequired: "ユーザー名が必要です。",
          passwordRequired: "パスワードが必要です。",
          webCryptoRequired: "クラウド同期には、この実行環境での Web Crypto サポートが必要です。",
          unsupportedSnapshot: "サポートされていない暗号化同期スナップショットです。",
          invalidSnapshot: "クラウド同期スナップショットが無効です。",
          revisionConflict:
            "リビジョンの競合があります。最新の状態をプルしてから再試行してください。",
          missingBearerToken: "Bearer トークンがありません。",
          invalidBearerToken:
            "セッションが無効または期限切れです。もう一度サインインしてください。",
          userNotFound: "ユーザーが見つかりません。",
          invalidJsonBody: "同期リクエストの本文が無効です。",
          invalidUsername: "ユーザー名が無効です。",
          userAlreadyExists: "ユーザーはすでに存在します。",
          invalidCredentials: "ユーザー名またはパスワードが無効です。",
          invalidBaseRevision: "ベースリビジョンが無効です。",
          notFound: "同期エンドポイントが見つかりません。",
          internalServerError: "同期サーバーエラーです。",
          requestFailed: "同期リクエストに失敗しました ({{status}})。",
        },
      },
    },
    diagnostics: {
