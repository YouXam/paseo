...
export const ko: TranslationResources = {
  ...
  settings: {
    ...
    general: {
      ...
      cloudSync: {
        title: "클라우드 동기화",
        rowTitle: "암호화된 UI 상태 동기화",
        rowHint:
          "호스트, 워크스페이스 탭, 레이아웃, 설정 및 텍스트 초안을 동기화합니다. 첨부 파일 데이터는 동기화되지 않습니다.",
        endpoint: {
          label: "동기화 엔드포인트",
          hint: "예: https://sync.example.com",
        ...
        signedInDetails: "{{username}} · 리비전 {{revision}} · {{lastSync}}",
        signedOutHint: "암호화에 사용한 것과 동일한 마스터 비밀번호로 등록하거나 로그인하세요.",
        actions: {
          push: "푸시",
          pull: "풀",
          signOut: "로그아웃",
        ...
        errorTitle: "클라우드 동기화 실패",
        errors: {
          signInRequired: "동기화하기 전에 로그인하세요.",
          endpointRequired: "동기화 엔드포인트가 필요합니다.",
          usernameRequired: "사용자 이름이 필요합니다.",
          passwordRequired: "비밀번호가 필요합니다.",
          webCryptoRequired:
            "이 런타임에서 클라우드 동기화를 사용하려면 Web Crypto 지원이 필요합니다.",
          unsupportedSnapshot: "지원되지 않는 암호화 동기화 스냅샷입니다.",
          invalidSnapshot: "잘못된 클라우드 동기화 스냅샷입니다.",
          revisionConflict: "리비전 충돌입니다. 최신 상태를 풀한 후 다시 시도하세요.",
          missingBearerToken: "Bearer 토큰이 없습니다.",
          invalidBearerToken: "세션이 잘못되었거나 만료되었습니다. 다시 로그인하세요.",
          userNotFound: "사용자를 찾을 수 없습니다.",
          invalidJsonBody: "동기화 요청 본문이 잘못되었습니다.",
          invalidUsername: "사용자 이름이 잘못되었습니다.",
          userAlreadyExists: "사용자가 이미 존재합니다.",
          invalidCredentials: "사용자 이름 또는 비밀번호가 잘못되었습니다.",
          invalidBaseRevision: "기본 리비전이 잘못되었습니다.",
          notFound: "동기화 엔드포인트를 찾을 수 없습니다.",
          internalServerError: "동기화 서버 오류입니다.",
          requestFailed: "동기화 요청 실패({{status}}).",
        },
      },
    },
    diagnostics: {
