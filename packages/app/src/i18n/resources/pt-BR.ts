  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        changedFile: "{{count}} arquivo",
        changedFiles: "{{count}} arquivos",
        fileActions: "Ações do arquivo",
        stageFile: "Adicionar às alterações staged",
        unstageFile: "Restaurar para a árvore de trabalho",
        failedStageFile: "Falha ao adicionar arquivo ao staging.",
        failedUnstageFile: "Falha ao remover arquivo do staging.",
        commits: {
          title: "Commits",
  ...
  settings: {
    ...
    general: {
      ...
      cloudSync: {
        ...
        rowTitle: "Sincronização criptografada do estado da interface",
        rowHint:
          "Sincroniza hosts, abas do workspace, layout, configurações e rascunhos de texto. Bytes de anexos não são sincronizados.",
        endpoint: {
          label: "Endpoint de sincronização",
          hint: "Exemplo: https://sync.example.com",
        ...
        signedInDetails: "{{username}} · revisão {{revision}} · {{lastSync}}",
        signedOutHint: "Registre-se ou entre com a mesma senha mestra usada para criptografia.",
        actions: {
          push: "Enviar",
          pull: "Baixar",
          signOut: "Sair",
        ...
        errorTitle: "Falha na sincronização na nuvem",
        errors: {
          signInRequired: "Entre antes de sincronizar.",
          endpointRequired: "O endpoint de sincronização é obrigatório.",
          usernameRequired: "O nome de usuário é obrigatório.",
          passwordRequired: "A senha é obrigatória.",
          webCryptoRequired: "A sincronização na nuvem exige suporte a Web Crypto neste ambiente.",
          unsupportedSnapshot: "Snapshot de sincronização criptografado não suportado.",
          invalidSnapshot: "Snapshot de sincronização na nuvem inválido.",
          revisionConflict: "Conflito de revisão. Baixe o estado mais recente e tente novamente.",
          missingBearerToken: "Token bearer ausente.",
          invalidBearerToken: "Sessão inválida ou expirada. Entre novamente.",
          userNotFound: "Usuário não encontrado.",
          invalidJsonBody: "Corpo da solicitação de sincronização inválido.",
          ...
          invalidBaseRevision: "Revisão base inválida.",
          notFound: "Endpoint de sincronização não encontrado.",
          internalServerError: "Erro do servidor de sincronização.",
          requestFailed: "Falha na solicitação de sincronização ({{status}}).",
        },
      },
    },
    diagnostics: {
