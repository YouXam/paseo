  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        workingTreeChanges: "Изменения рабочей области",
        changedFile: "{{count}} файл",
        changedFiles: "{{count}} файлов",
        fileActions: "Действия с файлом",
        stageFile: "Добавить в индексированные изменения",
        unstageFile: "Вернуть в рабочую область",
        failedStageFile: "Не удалось добавить файл в индекс.",
        failedUnstageFile: "Не удалось убрать файл из индекса.",
        commits: {
          title: "Коммиты",
  ...
  settings: {
    ...
    general: {
      ...
      cloudSync: {
        ...
        rowTitle: "Зашифрованная синхронизация состояния интерфейса",
        rowHint:
          "Синхронизирует хосты, вкладки рабочего пространства, макет, настройки и текстовые черновики. Байты вложений не синхронизируются.",
        endpoint: {
          label: "Конечная точка синхронизации",
          hint: "Пример: https://sync.example.com",
        ...
        lastSyncNever: "Еще не синхронизировалось",
        signedInDetails: "{{username}} · ревизия {{revision}} · {{lastSync}}",
        signedOutHint:
          "Зарегистрируйтесь или войдите с тем же главным паролем, который используется для шифрования.",
        actions: {
          push: "Отправить",
          pull: "Получить",
          signOut: "Выйти",
        ...
        errorTitle: "Ошибка облачной синхронизации",
        errors: {
          signInRequired: "Войдите перед синхронизацией.",
          endpointRequired: "Требуется конечная точка синхронизации.",
          usernameRequired: "Требуется имя пользователя.",
          passwordRequired: "Требуется пароль.",
          webCryptoRequired: "Облачная синхронизация требует поддержки Web Crypto в этой среде.",
          unsupportedSnapshot: "Неподдерживаемый зашифрованный снимок синхронизации.",
          invalidSnapshot: "Недопустимый снимок облачной синхронизации.",
          revisionConflict: "Конфликт ревизии. Получите последнее состояние и повторите попытку.",
          missingBearerToken: "Отсутствует bearer-токен.",
          invalidBearerToken: "Сеанс недействителен или истек. Войдите снова.",
          userNotFound: "Пользователь не найден.",
          invalidJsonBody: "Недопустимое тело запроса синхронизации.",
          invalidUsername: "Недопустимое имя пользователя.",
          userAlreadyExists: "Пользователь уже существует.",
          invalidCredentials: "Недопустимое имя пользователя или пароль.",
          invalidBaseRevision: "Недопустимая базовая ревизия.",
          notFound: "Конечная точка синхронизации не найдена.",
          internalServerError: "Ошибка сервера синхронизации.",
          requestFailed: "Ошибка запроса синхронизации ({{status}}).",
        },
      },
    },
    diagnostics: {
