  ...
  workspace: {
    ...
    git: {
      ...
      diff: {
        ...
        changedFile: "{{count}} 个文件",
        changedFiles: "{{count}} 个文件",
        fileActions: "文件操作",
        stageFile: "加入暂存区",
        unstageFile: "取消暂存，保留在工作区",
        failedStageFile: "加入暂存区失败。",
        failedUnstageFile: "取消暂存失败。",
        commits: {
          title: "提交",
  ...
  settings: {
    ...
    general: {
      ...
      cloudSync: {
        title: "云端同步",
        rowTitle: "加密同步应用数据",
        rowHint: "同步主机、工作区标签页、布局、设置和文本草稿。附件字节不会同步。",
        endpoint: {
          label: "同步端点",
          hint: "例如：https://sync.example.com",
        ...
        lastSyncNever: "尚未同步",
        signedInDetails: "{{username}} · 版本 {{revision}} · {{lastSync}}",
        signedOutHint: "使用同一个用于加密的主密码注册或登录。",
        actions: {
          push: "推送",
          pull: "拉取",
          signOut: "退出登录",
        ...
        errorTitle: "云端同步失败",
        errors: {
          signInRequired: "请先登录再同步。",
          endpointRequired: "需要填写同步端点。",
          usernameRequired: "需要填写用户名。",
          passwordRequired: "需要填写密码。",
          webCryptoRequired: "当前运行环境不支持云端同步所需的 Web Crypto。",
          unsupportedSnapshot: "不支持的加密同步快照。",
          invalidSnapshot: "云端同步快照无效。",
          revisionConflict: "版本冲突。请先拉取最新状态，然后重试。",
          missingBearerToken: "缺少 bearer 令牌。",
          invalidBearerToken: "会话无效或已过期。请重新登录。",
          userNotFound: "用户不存在。",
          invalidJsonBody: "同步请求内容无效。",
          invalidUsername: "用户名无效。",
          userAlreadyExists: "用户已存在。",
          invalidCredentials: "用户名或密码无效。",
          invalidBaseRevision: "基础版本无效。",
          notFound: "同步端点不存在。",
          internalServerError: "同步服务器错误。",
          requestFailed: "同步请求失败（{{status}}）。",
        },
      },
    },
    diagnostics: {
